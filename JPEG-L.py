...
def cooker(Q_trial):
    Q_matrix = fc.quantization_matrix(Q_trial) # Quantization matrix 
    ...
    compression_ratio = 24/bits_per_image_jpegl
    #print("number of bits per pixel = ", bits_per_image_jpegl)
    #print("compression ration total image: ", compression_ratio)

    return compression_ratio, image_plane_rec
...
compression_ratio, image_plane_rec = cooker(Q)
...
print(quality_fac[idx_max][0], cr[idx_max][0])
